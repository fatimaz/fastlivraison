                            ...
                            <div class="form-group">
                                ...
                                <select name="menu_id" class="select2 form-control">
                                    <optgroup label="Choose menu">
                                        ...
                                        <option value="{{$menu -> id }}" @if($menu -> id == $attribute -> menu_id) selected @endif>{{$menu -> name}}</option>
                                        @endforeach
                                        @endif
                                    </optgroup>
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" class="form-control" placeholder="" value="{{$attribute -> name}}" name="name">
                                @error("name")
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="min" class="form-control" placeholder="" value="{{$attribute -> min}}" name="min">
                                @error("min")
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="max" class="form-control" placeholder="" value="{{$attribute -> max}}" name="max">
                                @error("max")
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
