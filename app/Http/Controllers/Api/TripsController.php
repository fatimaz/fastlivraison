    ...
    public function index()
    {
      try {
         $user= auth('api')->user()->id; 
          // $offers = Offer::where('type','!=','rejected')->pluck('trip_id');
          $trips = Trip::with('user','countries','countriesto', 'offers','offers.shipment','offers.shipment.countries', 'offers.shipment.countriesto', 'offers.user','user.offers')
          ->where('user_id', $user)
