...
<div class="sl-mainpanel">
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            <h6 class="card-body-title">Add image</h6>
                                ...
                                <select name="prescription_id" class="select2 form-control">
                                    <optgroup label="Choose prescription">
                                      @if($prescriptions && $prescriptions -> count() > 0)
                                        ...
                                        <option
                                            value="{{$prescription -> id }}">{{ $prescription -> id}}</option>
                                        @endforeach
                                      @endif
                                    </optgroup>
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="name" name="name" >{{ old('name') }}</textarea>
                                @error("name")
