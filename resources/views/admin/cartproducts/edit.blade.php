    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            <div class="table-wrapper">
                ...
                <form class="form"
                    action="{{route('admin.cartproducts.update',$cartproduct -> id)}}"
                    method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="product_id" class="select2 form-control">
                                        ...
                                        @if($products && $products -> count() > 0)
                                            ...
                                            <option
                                                value="{{$product -> id }}"
                                              @if($product -> id == $cartproduct -> product_id) selected @endif>{{ $product -> name}}</option>
                                        @endforeach
                                        @endif
                                        </optgroup>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cart_id" class="select2 form-control">
                                        ...
                                        @if($carts && $carts -> count() > 0)
                                            ...
                                            <option
                                                value="{{$cart -> id }}"
                                              @if($cart -> id == $cartproduct -> cart_id) selected @endif>{{ $cart -> id}}</option>
                                        @endforeach
                                        @endif
                                        </optgroup>
                                    </select>
